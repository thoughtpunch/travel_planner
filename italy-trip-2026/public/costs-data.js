...
window.TRIP_COSTS = {
  ...
  fixed: [
    ...
    { id:'lo-milan', cat:'Lodging', label:'Milan — Milano Chic Retreat, Via Dugnani 1 · Sep 11–13', usd:606.05, status:'booked', note:'REBOOKED 2026-08-31 — moved from Via Capecelatro 55 (San Siro) because the ONE thing Dan wants in Milan is the Leonardo Science Museum and the old place was a 35-min two-line metro trek away. Via Antonio Dugnani 1, 20144 Milano (Coni Zugna M4) is a VERIFIED 600 m / 9-min walk to Via San Vittore 21 — matters because Kei has a knee problem. ELEVATOR in the building. 2 bedrooms (2 queens) + sofa bed = 6, 2 baths. Host Lorenzo, 4.44/368 reviews. Free cancellation 24h only. Old booking cancelled inside its free window; its $465.60 came back as an Airbnb credit, so the NET new outlay is $140.45', url:'https://www.airbnb.com/rooms/1762316434237207772', pay:'paid', paidUsd:606.05, paidDate:'2026-08-31', payRef:'Airbnb HMBJHFZ3QS · part-settled by the $465.60 credit from the cancelled Capecelatro booking' },
    ...
    { id:'tr-intercity', cat:'Trains', label:'5 intercity rail legs — 1 of 5 BOOKED', usd:560, status:'estimate', note:'LEG 1 BOOKED 2026-08-31: Frecciarossa 9304, Sun 13 Sep, Milano Porta Garibaldi 11:15 -> Torino Porta Nuova 12:20. PNR NY2TU5, EUR83.60, all six in Coach 8 (Dan 7D, Rhys 7C, Grey 7B, Kei 8D, Jude 8C, Keir 8B). Booked as ONE booking of 4 adults + 2 children — splitting saves nothing on this leg, verified. GET OFF AT PORTA SUSA (12:08): 230 m to the Turin flat vs 1.1 km from Porta Nuova. STILL TO BOOK — deadlines: Chiavari->Florence Sep 4, Turin->Chiavari + Florence->Rome Sep 11, Rome->Venice Sep 18. Splitting 4+2 DOES save on those four (EUR83.90 total)', pay:'pending', paidUsd:0, payRef:'Trenitalia PNR NY2TU5 (leg 1 only)', dueDate:'2026-09-04' },
